...
--
-- Table structure for table `tbl_meuapp_health`
--

DROP TABLE IF EXISTS `tbl_meuapp_health`;
...
CREATE TABLE `tbl_meuapp_health` (
  ...
  `frequencia_cardiaca` tinyint(3) unsigned DEFAULT NULL,
  ...
  KEY `idx_health_estado` (`estado`),
  KEY `idx_health_cid` (`cid`),
  CONSTRAINT `fk_health_user` FOREIGN KEY (`user_id`) REFERENCES `tbl_meuapp_patients` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-11-06 18:50:43
